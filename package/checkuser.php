    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="../element/logout.php" class="dropdown-item">
            <i class="fa fa-sign-out mr-2"></i> <?php echo iconv('TIS-620','UTF-8', "ออกจากระบบ");?>
          </a>
      </li>
      <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                      <div class="jumbotron">
							 <h1><i class="fa fa-warning text-danger"></i> พบข้อผิดพลาดที่เกิดขึ้น</h1> 
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เนื่องจากผู้ใช้งานยังไม่มีสิทธิ์ในการเข้าถึงข้อมูลภายในระบบงานสารสนเทศเพื่อการบริการ หรือมีสิทธิ์เข้าถึงข้อมูลเฉพาะข้อมูลบางส่วนที่กำหนดให้ใช้งานได้เท่านั้น</p> 
						</div>
