...
/*******************************************************************************
*                               Public methods  barcode                               *
*******************************************************************************/
function EAN13($x, $y, $barcode, $h=4, $w=.20)
{
...
function Code39($x, $y, $code, $ext = true, $cks = false, $w = 0.4, $h = 20, $wide = true) {
	...
	//Display code แสดงโค้ดใต้แถบบาร์โค้ด
	//$this->SetFont('Arial', '', 5);
	$this->Text($x + 14.5, $y+$h+2.5, $code);
...
*******************************************************************************/
		function ThaiPDF($orientation='P',$unit='mm',$format='A4'){
			...
			if(is_string($format))	{
				...
				if($format=='a2')	$format=array(1190.55,1683.78);
				elseif($format=='a2h') $format=array(1683.78,1190.55);

				elseif($format=='a3')	$format=array(841.89,1190.55);
				elseif($format=='a3h') $format=array(1190.55,841.89);


				elseif($format=='a4') $format=array(595.28,841.89);
				elseif($format=='a4h') $format=array(841.89, 595.28);
...
*******************************************************************************/
		...
		function _putinfo() {
			$this->_out('/Producer '.$this->_textstring('un-no Corp.'));
		...
		//------------------ AngsanaNew --------------------------------
			...
			$this->AddFont('THSarabunNew','B','THSarabunNewBold.php');
			$this->AddFont('THSarabunNew','I','THSarabunNewItalic.php');
			$this->AddFont('THSarabunNew','IB','THSarabunNewBoldItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THNiramitAS -----------------------------
			$this->AddFont('THNiramitAS','','THNiramitAS.php');
			$this->AddFont('THNiramitAS','B','THNiramitASBold.php');
			$this->AddFont('THNiramitAS','I','THNiramitASItalic.php');
			$this->AddFont('THNiramitAS','IB','THNiramitASBoldItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THKrub -----------------------------
			$this->AddFont('THKrub','','THKrub.php');
			$this->AddFont('THKrub','B','THKrubBold.php');
			$this->AddFont('THKrub','I','THKrubItalic.php');
			$this->AddFont('THKrub','IB','THKrubBoldItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THKodchasal -----------------------------
			$this->AddFont('THKodchasal','','THKodchasal.php');
			$this->AddFont('THKodchasal','B','THKodchasalBold.php');
			$this->AddFont('THKodchasal','IB','THKodchasalBoldItalic.php');
			$this->AddFont('THKodchasal','I','THKodchasalItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THK2DJuly8 -----------------------------
			$this->AddFont('THK2DJuly8','','THK2DJuly8.php');
			$this->AddFont('THK2DJuly8','B','THK2DJuly8Bold.php');
			$this->AddFont('THK2DJuly8','IB','THK2DJuly8BoldItalic.php');
			$this->AddFont('THK2DJuly8','I','THK2DJuly8Italic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THMaliGrade6 -----------------------------
			$this->AddFont('THMaliGrade6','','THMaliGrade6.php');
			$this->AddFont('THMaliGrade6','B','THMaliGrade6Bold.php');
			$this->AddFont('THMaliGrade6','IB','THMaliGrade6BoldItalic.php');
			$this->AddFont('THMaliGrade6','I','THMaliGrade6Italic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THChakraPetch -----------------------------
			$this->AddFont('THChakraPetch','','THChakraPetch.php');
			$this->AddFont('THChakraPetch','B','THChakraPetchBold.php');
			$this->AddFont('THChakraPetch','IB','THChakraPetchBoldItalic.php');
			$this->AddFont('THChakraPetch','I','THChakraPetchItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THBaijam -----------------------------
			$this->AddFont('THBaijam','','THBaijam.php');
			$this->AddFont('THBaijam','B','THBaijamBold.php');
			$this->AddFont('THBaijam','IB','THBaijamBoldItalic.php');
			$this->AddFont('THBaijam','I','THBaijamItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THKoHo -----------------------------
			$this->AddFont('THKoHo','','THKoHo.php');
			$this->AddFont('THKoHo','B','THKoHoBold.php');
			$this->AddFont('THKoHo','IB','THKoHoBoldItalic.php');
			$this->AddFont('THKoHo','I','THKoHoItalic.php');
			//------------------------------ End ---------------------------------
			//---------------------- THFahkwang -----------------------------
			$this->AddFont('THFahkwang','','THFahkwang.php');
			$this->AddFont('THFahkwang','B','THFahkwangBold.php');
			$this->AddFont('THFahkwang','IB','THFahkwangBoldItalic.php');
			$this->AddFont('THFahkwang','I','THFahkwangItalic.php');
			//------------------------------ End ---------------------------------
		}

		function printTextVerticalCenter($txt, $w)
	{
		$cellTotalLine = 0;
		$cw=&$this->CurrentFont['cw'];
		$wmax=($w-2*$this->cMargin)*1000/$this->FontSize;
...
class unnoPDF extends ThaiPDF
{
	...
	function SetMode($_mode)
	{
		...
		{
			case 'a4l' : 
				$this -> _condinate = array('l' => 15, 't' => 10, 'r' => 285, 'b' => 195, 'hh' => 20, 'mgh' => 5);
				break;
			case 'a3l' : 
				$this -> _condinate = array('l' => 15, 't' => 10, 'r' => 410, 'b' => 285, 'hh' => 20, 'mgh' => 5);
				break;
			case 'a2l' : 
				$this -> _condinate = array('l' => 15, 't' => 10, 'r' => 583, 'b' => 405, 'hh' => 20, 'mgh' => 5);
				break;
		}
	}

	function AddHeader($page = 0)
	{
		$this -> AddPage();

		$this -> Image('./image/logo.png', $this -> _condinate['l'], $this -> _condinate['t'], 14, 14);

		$this -> SetFont('AngsanaNew','B',12); 
		$this -> SetXY($this -> _condinate['l'] + 15, $this -> _condinate['t'] - 2);
		$this -> MultiCell(100, 5, $this -> header_text, 0, 'L', 0);

		$this -> SetFont('AngsanaNew', '', 12); 
		$this -> SetXY($this -> _condinate['l'] + 18, $this -> _condinate['t'] + 3);
		$this -> MultiCell(100, 5, $this -> detail_text, 0, 'L', 0);

		$this -> SetXY($this -> _condinate['r'] - 50, $this -> _condinate['t'] + 8);
		$this -> MultiCell(50, 5, 'ที่ ............ / .............................' , 0, 'R', 0);

		if($this -> pageFile > 1)
		{
			$this -> SetXY($this -> _condinate['r'] - 50, $this -> _condinate['t'] + 3);
			$this -> MultiCell(50, 5, 'หน้าที่  ' . $this -> pageFile , 0, 'R', 0);
		}

		$this -> Line($this -> _condinate['l'], $this -> _condinate['t'] + 15, $this -> _condinate['r'], $this -> _condinate['t'] + 15);
		$this -> Line($this -> _condinate['l'], $this -> _condinate['b'], $this -> _condinate['r'], $this -> _condinate['b']);



		$this -> SetFont('AngsanaNew', '', 10); 
		
		$this -> SetXY($this -> _condinate['r'] - 50, $this -> _condinate['t'] - 2);
		$this -> MultiCell(50, 5, $this -> conner_text, 0, 'R', 0);

		$this -> SetXY($this -> _condinate['r'] - 100, $this -> _condinate['b']);
		$this -> MultiCell(100, 7, 'ออกรายงานโดย ' . $this -> reportby_text . ' : เมื่อ ' . $this -> reporttime_text, 0, 'R', 0);
		
		$this -> SetTextColor(255, 255, 255);
		$this -> SetXY($this -> _condinate['l'], $this -> _condinate['b']);
		$this -> MultiCell(100, 7, '(c) Copyright un-no Corporation All right reserved', 0, 'L', 0);
