 ...
 (function ( $ ) {
      ...
      return weeks;
		...
		*/
		var draw = function() {
		  ...
		  $("#target-getDate").load("./package/detail/getactivities.php?pagedata="+ (y+"-"+(m+1)+"-"+d));
          ...
          headerGroup.append("<h2>"+ headerMonth +" "+ (y + 543) +"</h2>");
          ...
          if (settings.showNotes) {
                ...
                if (notesLength > 0) {
                      ...
                      for (var i = 0; i < notesLength; i++) {
                            ...
                            var list = "";
                            list += "<li class='date'>";
                            list += "<span style=\"color:#33cc00;\"><strong>วันที่ "+ date +"</strong></span> ";
    ...
    var getNotesThisMonth = function() {
		...
		var nextMonth = function() {
            ...
            // document.getElementById("ymd").value = (year+"-"+month+"-"+date);
			$("#target-getDate").load("./package/detail/getactivities.php?pagedata="+ (year+"-"+(month+1)+"-"+date));
			draw();
		}
